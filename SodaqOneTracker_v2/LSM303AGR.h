...
public:
    ...
    LSM303AGR(TwoWire& wire = Wire, uint8_t accelAddress = LSM303AGR_ACCEL_ADDRESS, uint8_t magAddress = LSM303AGR_MAG_ADDRESS);
    ...
    double getX() { return getGsFromScaledValue(readAccelRegister16Bits(LSM303AGR::OUT_X_L_A)); };
    double getY() { return getGsFromScaledValue(readAccelRegister16Bits(LSM303AGR::OUT_Y_L_A)); };
    double getZ() { return getGsFromScaledValue(readAccelRegister16Bits(LSM303AGR::OUT_Z_L_A)); };
protected:
    TwoWire& _wire;
